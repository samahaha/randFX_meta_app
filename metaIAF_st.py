...
config = {'Study name' : st.column_config.Column('Study name', help="Shorthand name for the study (just for display - not required)"),
          'r' : st.column_config.NumberColumn('r', min_value=-1, max_value=1, help="Correlation _r_-value (typically Pearson's _r_)"),
          'n' : st.column_config.NumberColumn('n', min_value=2, help="Sample size of the study")}
with col1:
