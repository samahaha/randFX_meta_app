...
st.markdown("Plots and statistics will update after any change to the table. To delete a whole row, click the grey square on the far left of the row and press delete on your keyboard. To add data, click on the empty cell at the bottom of the table. Refresh the page to repopulate the original data.")
